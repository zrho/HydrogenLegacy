...
%define HYDROGEN_MEMORY_PAGE_PML4		HYDROGEN_MEMORY + 0x08000
%define HYDROGEN_MEMORY_PAGE_PDP_IDN	HYDROGEN_MEMORY + 0x09000
%define HYDROGEN_MEMORY_PAGE_PD_IDN		HYDROGEN_MEMORY + 0x0A000
%define HYDROGEN_MEMORY_PAGE_PDP_KERNEL	HYDROGEN_MEMORY + 0x4A000
%define HYDROGEN_MEMORY_PAGE_PD_KERNEL	HYDROGEN_MEMORY + 0x4B000
%define HYDROGEN_MEMORY_PAGE_PT_KERNEL	HYDROGEN_MEMORY + 0x4C000

%define HYDROGEN_MEMORY_STACK			HYDROGEN_MEMORY + 0x4D000
%define HYDROGEN_MEMORY_END				HYDROGEN_MEMORY + 0x6E000
